...
try:
    ...
    logger.warning("Could not import PerformancePredictor. Make sure the model is trained.")
...
def initialize_app():
    ...
    try:
        ...
        if PerformancePredictor and os.path.exists(model_path):
            ...
            logger.warning("Model not found. Prediction endpoints will not work.")
        ...
        if os.path.exists(expanded_data_path):
            ...
            logger.warning("Dataset not found. Report endpoints will have limited functionality.")
